#pragma once
   ...
   #define PCINT_INT0_PIN 10
   #define PCINT_INT1_PIN 11
   #define PCINT_INT2_PIN 12
   #define PCINT_INT3_PIN 13
   #define PCINT_INT4_PIN 50
   #define PCINT_INT5_PIN 51
   #define PCINT_INT6_PIN 52
   #define PCINT_INT7_PIN 53
   #define PCINT_INT8_PIN 62
   #define PCINT_INT9_PIN 63
   #define PCINT_INT10_PIN 64
   #define PCINT_INT11_PIN 65
   #define PCINT_INT12_PIN 66
   #define PCINT_INT13_PIN 67
   #define PCINT_INT14_PIN 68
   #define PCINT_INT15_PIN 69
#endif